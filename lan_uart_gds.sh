...
# fprime-billee-rcm's are both attached to the same host. (This used to be
# hardcoded to /dev/ttyACM1 after observing the current boot's enumeration
# order, which is exactly the fragile guess this symlink replaces.)
