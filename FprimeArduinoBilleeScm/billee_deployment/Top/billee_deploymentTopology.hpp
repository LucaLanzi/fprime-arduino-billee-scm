// ======================================================================
// \title  billee_deploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef BILLEE_DEPLOYMENT_BILLEE_DEPLOYMENTTOPOLOGY_HPP
#define BILLEE_DEPLOYMENT_BILLEE_DEPLOYMENTTOPOLOGY_HPP
// Included for access to billee_deployment::TopologyState and billee_deployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <billee_deployment/Top/billee_deploymentTopologyDefs.hpp>

// Remove unnecessary billee_deployment:: qualifications
 ...
 * billee_deployment::TopologyState see: billee_deploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type billee_deployment::TopologyState see: billee_deploymentTopologyDefs.hpp.
 *
